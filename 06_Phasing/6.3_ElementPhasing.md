...
<br>
In the DPS Template you will see multiple phases, for Revit elements you'll only need to be concerned with Existing and New construciton as to what you assign each element. The other phases explained can be found <a href="/06_Phasing/6-3_annotationphasing.md">Here</a>
<br>
